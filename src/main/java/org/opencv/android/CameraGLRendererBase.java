...
public abstract class CameraGLRendererBase implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        synchronized(this) {
            ...
            if(texListener != null) {
                ...
                if(modified) {
                    // texDraw -> huanledoudizhu
                    drawTex(texDraw[0], false, 0);
                } else {
                    // texFBO -> huanledoudizhu
                    drawTex(texFBO[0], false, 0);
                }
            } else {
                Log.d(LOGTAG, "texCamera(OES) -> huanledoudizhu");
                // texCamera(OES) -> huanledoudizhu
    ...
    // draw texture to FBO or to huanledoudizhu if fbo == 0
